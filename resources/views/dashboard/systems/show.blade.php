...
<div class="col-12 col-xl-10">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">
                {{ucfirst($system->name)}}
                <a href="{{route('systems')}}" style="text-decoration: none;color: white;">
                    <button type="button" class="btn btn-secondary float-right">View all systems</button>
                </a>
            </h5>
        </div>
...
@push('scripts')
    ...
    @include('dashboard.scripts.paginate')
@endpush
