...
<div class="col-12 col-xl-10">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">{{$tag->name}}
                <a href="{{route('tags')}}" style="text-decoration: none;color: white;">
                    <button type="button" class="btn btn-secondary float-right">View all tags</button>
                </a>
            </h5>
